...
const suites = {
  ...
  "brain-merged": {
    // Registrations re-homed by the lead when the registry, duplicated whole by an earlier conflict resolution, was rebuilt from its first copy.
    bundles: [
      ["src/lib/arrangementArc.test.ts", "arrangement-arc.test.mjs", ["--alias:@workspace/db=./src/lib/musicProviders.testDbStub.ts"]],
  ...
  "brain-b10": {
    bundles: [
      ["src/lib/brainB10Motif.test.ts", "brain-b10-motif.test.mjs", ["--alias:@workspace/db=./src/lib/musicProviders.testDbStub.ts"]],
      ["src/lib/melodicEngine.test.ts", "melodic-engine.test.mjs", ["--alias:@workspace/db=./src/lib/musicProviders.testDbStub.ts"]],
  ...
  "brain-b08": {
    bundles: [
      ...
      ["src/lib/compositionRights.test.ts", "composition-rights.test.mjs", ["--alias:@workspace/db=./src/lib/musicProviders.testDbStub.ts"]],
  ...
  "brain-b13": {
    bundles: [
      ["src/lib/brainB13Wiring.test.ts", "brain-b13-wiring.test.mjs", ["--alias:@workspace/db=./src/lib/musicProviders.testDbStub.ts"]],
      ["src/lib/composer/texture.test.ts", "texture.test.mjs", ["--alias:@workspace/db=./src/lib/musicProviders.testDbStub.ts"]],
    ],
  },
  "brain-b07": {
    bundles: [
      ["src/lib/critics/audioControls.test.ts", "audio-controls.test.mjs", ["--alias:@workspace/db=./src/lib/musicProviders.testDbStub.ts"]],
      ["src/lib/critics/dimensions/audioDimensions.test.ts", "audio-dimensions.test.mjs", ["--alias:@workspace/db=./src/lib/musicProviders.testDbStub.ts"]],
      ["src/lib/evaluationCritique.test.ts", "evaluation-critique.test.mjs", ["--alias:@workspace/db=./src/lib/musicProviders.testDbStub.ts"]],
      ["src/lib/evaluationRender.test.ts", "evaluation-render.test.mjs", ["--alias:@workspace/db=./src/lib/musicProviders.testDbStub.ts"]],
      ["src/lib/exportRenderOffThread.test.ts", "export-render-off-thread.test.mjs", ["--alias:@workspace/db=./src/lib/musicProviders.testDbStub.ts"]],
