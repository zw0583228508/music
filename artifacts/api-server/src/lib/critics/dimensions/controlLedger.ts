...
export const CONTROL_LEDGER: Record<string, LedgerEntry> = {
  density: { status: "gated", strongestControl: "arrival_thinned_and_softened", detectionRate: 1, ci95: [0.6637, 1], n: 9, cleanAnchorBlockingRate: 0, gatingTransforms: ["arrival_thinned_and_softened","piano_one_note_per_bar","strip_bed_to_top_voice"], reason: "3 independent non-prepared transforms passed (arrival_thinned_and_softened, piano_one_note_per_bar, strip_bed_to_top_voice) and no clean anchor is blocked" },
  emotionalArcAndTension: { status: "gated", strongestControl: "flatten_arc", detectionRate: 1, ci95: [0.6637, 1], n: 9, cleanAnchorBlockingRate: 0, gatingTransforms: ["flatten_arc","swap_climax_with_quietest"], reason: "2 independent non-prepared transforms passed (flatten_arc, swap_climax_with_quietest) and no clean anchor is blocked" },
  ...
  melodyAndCounterline: { status: "gated", strongestControl: "top_line_into_vocal_register", detectionRate: 1, ci95: [0.6637, 1], n: 9, cleanAnchorBlockingRate: 0, gatingTransforms: ["top_line_erratic","top_line_into_vocal_register"], reason: "2 independent non-prepared transforms passed (top_line_erratic, top_line_into_vocal_register) and no clean anchor is blocked" },
  motifRecurrenceAndDevelopment: { status: "informing", strongestControl: "random_pitch", detectionRate: 0.8889, ci95: [0.5175, 0.9972], n: 9, cleanAnchorBlockingRate: 0, gatingTransforms: [], reason: "0 of 2 independent non-prepared transforms pass" },
  orchestration: { status: "gated", strongestControl: "drums_only", detectionRate: 1, ci95: [0.6637, 1], n: 9, cleanAnchorBlockingRate: 0, gatingTransforms: ["drums_only","silence_planned_family"], reason: "2 independent non-prepared transforms passed (drums_only, silence_planned_family) and no clean anchor is blocked" },
  ...
  repetitionVsVariation: { status: "informing", strongestControl: "bar_copy_repetition@3", detectionRate: 0.5484, ci95: [0.3603, 0.7268], n: 31, cleanAnchorBlockingRate: 0, gatingTransforms: [], reason: "0 of 2 independent non-prepared transforms pass; caught chorus_copy 5/5, chorus_copy+develop_chorus_2 5/5 but on fewer than 8 items (the transform does not apply to every anchor)" },
