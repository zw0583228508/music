...
export const chassidicBallad: StyleKnowledgeEntry = {
  ...
  levels: {
    ...
    orchestration: {
      "arrangement.introFigure": kv("piano_motif", 0.55, "the piano states the tune's first phrase over the intro; that is how the produced nigun opens"),
      "arrangement.endingGesture": kv("held_final_chord", 0.6, "the last chord is held under a ritardando while the room sings out"),
  ...
  pulse: {
    writtenBpm: { min: 48, max: 110 },
    above: "half_time",
    below: "as_written",
    strategy: "steady_pulse",
    halfTimeStrategy: "half_time_feel",
    never: ["four_on_floor", "syncopated", "swing"],
    confidence: 0.75,
    why: "the nigun breathes with the voice; a soft two-and-four arrives with the first chorus and sits on the felt pulse, not on the counted one. Kick on every beat is the simcha dance, not this form.",
  },
